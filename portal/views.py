...
HUB_NAV_ITEMS = [
    {'url_name': 'staff_hub', 'icon': 'staff/icons/staff.svg', 'label': 'Staff', 'prefix': '/staff/', 'module_key': 'staff_hub'},
...
PORTAL_ADMIN_NAV_ITEM = {
    'url_name': 'portaladmin_home', 'icon': 'inclusion/icons/shield_check.svg', 'label': 'Portal Admin', 'prefix': '/portal-admin/',
}
    ...
    return [
        {
            ...
            'icon_template': 'staff/icons/staff.svg',
        },
        {
            'title': 'Student',
        ...
        },
        {
            ...
            'icon_template': 'inclusion/icons/send.svg',
        },
        {
            'title': 'Registers',
        ...
        },
        {
            ...
            'items': [_leaf(k) for k in (
                'medical_profiles', 'medical_log', 'medical_immunisations', 'medical_stock',
            )],
        ...
        },
        {
            ...
            'items': [],
            'icon_template': 'careers/icons/careers.svg',
        },
        {
            'title': 'Operations',
            'module_key': 'services',
            ...
            'icon_template': 'services/icons/services.svg',
        },
        {
            'title': 'Resources',
            ...
            'icon_template': 'resources/icons/resources.svg',
        },
    ]
...
def build_sections(request):
    ...
    if staff and staff.is_developer:
        sections.append({
            ...
            'items': [],
            'icon_template': 'inclusion/icons/shield_check.svg',
        })
    return sections
