...
urlpatterns = [
    ...
    path('actions/<int:action_id>/updates/', views.inclusion_panel_action_add_update, name='inclusion_panel_action_add_update'),
    ...
    path('meetings/<int:panel_id>/attendance/', views.inclusion_panel_meeting_attendance, name='inclusion_panel_meeting_attendance'),
    ...
    path('meetings/<int:panel_id>/activity-poll/', views.inclusion_panel_meeting_activity_poll, name='inclusion_panel_meeting_activity_poll'),
    path('meetings/discussion/<int:panel_referral_id>/', views.inclusion_panel_discussion, name='inclusion_panel_discussion'),
    path('meetings/discussion/<int:panel_referral_id>/recordings/', views.inclusion_panel_discussion_recording_upload, name='inclusion_panel_discussion_recording_upload'),
    ...
    path('safeguarding-notes/', views.inclusion_panel_safeguarding_notes, name='inclusion_panel_safeguarding_notes'),
    path('safeguarding-notes/<int:panel_referral_id>/notes/', views.inclusion_panel_safeguarding_notes_mutate, name='inclusion_panel_safeguarding_notes_mutate'),
]
