...
def resources_hub(request):
    return render(request, 'hubs/resources/hub.html', {'local_menu': _local_menu(request), 'hub_title': 'Resources'})


def resource_asset_register(request):
    return render(request, 'hubs/resources/asset_register.html', {'local_menu': _local_menu(request), 'hub_title': 'Resources'})


def resource_room_bookings(request):
    return render(request, 'hubs/resources/room_bookings.html', {'local_menu': _local_menu(request), 'hub_title': 'Resources'})
